...
const getImageFromApi = (value, per_page)=>{
    gallery.innerHTML = "";
    return (0, _fetchApi.fetchApi)(value, per_page).then((res)=>{
...
const searchInputDelay = (e)=>{
    ...
    if (value.length === 0) gallery.innerHTML = "";
...
},{"./api/fetchApi":"5QUeH"}],"5QUeH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchApi", ()=>fetchApi);
const fetchApi = async (value, per_page)=>{
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequiref08d", {})

//# sourceMappingURL=project-four-async.31b563d9.js.map
